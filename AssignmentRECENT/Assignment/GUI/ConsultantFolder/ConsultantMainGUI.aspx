<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultantMainGUI.aspx.cs" Inherits="GUI.ConsultantFolder.ConsultantMainGUI" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                <td>
                    <p>Welcome <asp:Label ID="lblTest" runat="server" Text="Username"></asp:Label></p>
            ...
            <tr>
                <td>
                    <asp:ListBox ID="lstReports" runat="server" Width="328px" Height="208px"></asp:ListBox>
